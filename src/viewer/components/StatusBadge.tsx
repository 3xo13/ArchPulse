...
const STATUS_STYLES: Record<VerifyResult["status"], { bg: string; color: string; border: string; label: string }> = {
...
const SIZE: Record<NonNullable<Props["size"]>, { fontSize: number; padding: string; borderRadius: number }> = {
